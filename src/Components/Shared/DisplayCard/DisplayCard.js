...
const DisplayCard = ({
    ...
    return ( <
        div className = {
            `card  md:card-side border-2 bg-base-100 shadow-md
        `
        } >
        {
            category.isBoosted && ( <
                div className = {
                    `absolute -top-12 -left-4 flex justify-between items-center `
                } >
                <
                img src = {
                    hotProduct
        ...
        <
        img className = "p-3 object-cover object-fill rounded-2xl md:w-[290px]"
        src = {
            category ? .images
        }
        alt = {
        ...
        <
        button onClick = {
            () => addBookNowHandelar(category._id)
        }
