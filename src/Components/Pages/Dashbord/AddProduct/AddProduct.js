...
const AddProduct = () => {
    ...
    return ( <
        ...
        <
        form onSubmit = {
            handleSubmit(addProductHandelar)
        }
        ...
        <
        select onClick = {
            (event) => setAddNew(event.target.value)
        } { ...register("category", {
                required: "Please Select Product Category!",
            })
        }
        className = {
            `select  select-bordered border-2 w-full ${
        ...
        className = {
            `input p-2 input-bordered border-2 w-full ${
        ...
        value = "Add Product"
        className = {
            `input btn btn-outline hover:bg-primary input-bordered w-full ${
                loading && "loading"
              }`
        } >
        {
        ...
        /form> <
        div className = {
            `absolute w-100 h-full top-[0%] mt-40 left-20 ${
