...
const ManageUser = () => {
    ...
    return ( <
        ...
        <
        select onChange = {
            (event) => setRole(event.target.value)
        } >
        <
        ...
        tbody > {
            users ? .map((user, i) => ( <
                ...
                /Link> <
                span className = {
                    `badge-md bg-none  -top-3 -right-2 ${
                ...
                td > {
                    user.userStatus ? ( <
                        button onClick = {
                            () => userUnVeifyHandelar(user ? ._id, user.email)
                        }
                        ...
                        button onClick = {
                            () => userVeifyHandelar(user ? ._id, user ? .email)
                        }
                ...
                <
                button onClick = {
                    () => removeUserHandelar(user._id, user.email)
                }
                className = "btn btn-sm bg-red-600 text-white" >
                deleted <
                /button> <
