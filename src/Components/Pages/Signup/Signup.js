...
const Signup = () => {
    ...
    return ( <
        ...
        div className = "py-2 " >
        <
        input checked className = "mr-1 cursor-pointer"
        id = "customer"
        type = "radio" { ...register("role")
        }
        value = "customer" /
        >
        <
        ...
        Customer <
        /label> <
        input className = "mx-1 cursor-pointer"
        id = "seller"
        type = "radio" { ...register("role")
        }
        value = "seller" /
        ...
        value = "Sign Up"
        className = {
            `input btn bg-primary text-white input-bordered w-full ${
                  loading && "loading"
                }`
        } >
        {
        ...
        <
        Link to = "../login"
        className = "text-primary pl-2 font-bold" >
        Login <
        /Link> <
        /p> <
        /div> <
